    ...
    public static int toPhoneKeyCode(int awtKeyCode, boolean jPhoneDirectionalLayout) {
        if (jPhoneDirectionalLayout) {
            return switch (awtKeyCode) {
                case KeyEvent.VK_UP, KeyEvent.VK_KP_UP, KeyEvent.VK_NUMPAD8 -> Canvas.UP;
                case KeyEvent.VK_LEFT, KeyEvent.VK_KP_LEFT, KeyEvent.VK_NUMPAD4 -> Canvas.LEFT;
                case KeyEvent.VK_RIGHT, KeyEvent.VK_KP_RIGHT, KeyEvent.VK_NUMPAD6 -> Canvas.RIGHT;
                case KeyEvent.VK_DOWN, KeyEvent.VK_KP_DOWN, KeyEvent.VK_NUMPAD2 -> Canvas.DOWN;
                case KeyEvent.VK_ENTER, KeyEvent.VK_NUMPAD5 -> Canvas.FIRE;
