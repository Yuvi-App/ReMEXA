...
public class OpglGraphics {
    ...
    public static final int GL_BYTE = 0;
    ...
    public static final int GL_COLOR_ARRAY = 0;
    ...
    public static final int GL_EXTENSIONS = 0;
    ...
    public static final int GL_INVALID_ENUM = 0;
    public static final int GL_INVALID_OPERATION = 0;
    public static final int GL_INVALID_VALUE = 0;
    ...
    public static final int GL_LINES = 0;
    ...
    public static final int GL_MATRIX_INDEX_ARRAY_OES = 0;
    ...
    public static final int GL_MATRIX_PALETTE_OES = 0;
    ...
    public static final int GL_NORMAL_ARRAY = 0;
    ...
    public static final int GL_RENDERER = 0;
    ...
    public static final int GL_SHORT = 0;
    ...
    public static final int GL_TRIANGLE_STRIP = 0;
    ...
    public static final int GL_VENDOR = 0;
    public static final int GL_VERSION = 0;
    public static final int GL_VERTEX_ARRAY = 0;
    ...
    public static final int GL_WEIGHT_ARRAY_OES = 0;
